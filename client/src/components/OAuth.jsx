import { GoogleAuthProvider , signInWithPopup , getAuth } from 'firebase/auth' // import the GoogleAuthProvider class
import { app } from '../firebase'
import { useDispatch } from 'react-redux'
import { SignInSuccess } from '../redux/applicant/applicantSlice'
...
export default function OAuth() {
  ...
  const handleGoogleClick = async () => {
    ...
    try {
      ...
      console.log('Failed to Authenticate with Gooogle' ,error)
    }
  }
  return (
